...
public class RouteAsker {
    ...
    public Route askForRoute(CollectionManager collection) {
    ...
    public Route askForRoute(CollectionManager collection, String[] args) {
    ...
    private static Integer idGenerator(CollectionManager collection) {
